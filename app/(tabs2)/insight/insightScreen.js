    ...
    function drunkAndTargetInfo() {
        return (
            <View style={{ ...styles.woakupAndSleepDrunkAndTargetInfoWrapStyle, flexDirection: isRtl ? 'row-reverse' : 'row' }}>
                <View style={{
                    ...styles.infoHookStyle,
                    borderBottomLeftRadius: isRtl ? 0 : Sizes.fixPadding - 2.0,
                    borderTopLeftRadius: isRtl ? 0 : Sizes.fixPadding - 2.0,
                    borderTopRightRadius: isRtl ? Sizes.fixPadding - 2.0 : 0,
                    borderBottomRightRadius: isRtl ? Sizes.fixPadding - 2.0 : 0
                }} />
    ...
    function nutritionInfo() {
        ...
        return (
            <FlatList
                ...
                scrollEnabled={false}
                contentContainerStyle={{ paddingHorizontal: Sizes.fixPadding, paddingTop: Sizes.fixPadding - 8.0 }}
            />
        )
    }
    ...
    function sleepStatisticsInfo() {
        ...
        return (
            <View style={{ marginHorizontal: Sizes.fixPadding * 2.0, marginBottom: Sizes.fixPadding * 2.0, }}>
                ...
                <View style={{ ...styles.chartInfoWrapStyle, paddingBottom: Sizes.fixPadding + 5.0 }}>
                    <View style={{ margin: Sizes.fixPadding * 2.0, flexDirection: isRtl ? 'row-reverse' : 'row', justifyContent: 'space-between' }}>
    ...
    function sleepingDetail() {
            ...
            return (
                <View style={styles.nutritionAndSleepingInfoBoxStyle}>
                    <Image
                        ...
                        style={{ width: 60.0, height: 60.0, resizeMode: 'contain', }}
                    />
                    <Text numberOfLines={1} style={{ marginTop: Sizes.fixPadding * 2.0, textAlign: 'center', ...Fonts.blackColor16Medium }}>
                        {item.title}
                    </Text>
                    <Text numberOfLines={1} style={{ marginTop: Sizes.fixPadding - 5.0, ...Fonts.primaryColor18SemiBold }}>
                        {item.description}
                    </Text>
                </View>
            )
        ...
        return (
            <FlatList
                ...
                showsVerticalScrollIndicator={false}
                scrollEnabled={false}
                contentContainerStyle={{ paddingTop: Sizes.fixPadding - 8.0, paddingHorizontal: Sizes.fixPadding }}
            />
        )
    }
